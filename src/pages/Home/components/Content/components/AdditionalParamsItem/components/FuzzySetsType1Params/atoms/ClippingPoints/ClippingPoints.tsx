...
export const ClippingPoints = observer(() => {
  ...
  return (
    <Form.Group className="fuzzy-sets-type1-params__form-group">
      <Form.Label>
        ClippingPoints
      </Form.Label>
      <InputGroup>
      ...
      />
      <div className="fuzzy-sets-type1-params__clipping-points-badges">
        {
          points.map((value, index) => {
            return (
              <h5
                key={index}
                className="fuzzy-sets-type1-params__clipping-points-badge"
              >
                <Badge
                  bg="primary"
